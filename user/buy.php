...
<div class="col-md-5">
  ...
  <a href="#" class="thumbnail">
      <img src="<?php echo $img; ?>" style="height:400px; width:400px;" />
    </a>
</div>
...
<a href="addtocart.php?id=<?php echo $id; ?>"><input type="button" name="btnaddtocart" class="btn btn-default" value="Add to cart" style="height:50px;width:130px;"></a>
