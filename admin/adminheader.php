  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li ><a href="prodis.php">Product Details<span class="sr-only">(current)</span></a></li>
        <li><a href="proinsert.php">Add new Product</a></li>
		<li><a href="catdis1.php">Category Details</a></li>
       <li><a href="catinsert.php">Add new Category</a></li>
      </ul>
